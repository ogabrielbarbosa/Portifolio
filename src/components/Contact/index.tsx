...
import { ContainerContact, SubContainerTexts, TextTitle, SubTextTitle, SubContainerContact, BoxContact, Icon, BoxTexts, TitleContact, LinkText, BoxCV, LinkTextCV, TitleContactCV } from './styles';
    ...
    return (
        <ContainerContact id="contato">
            <SubContainerTexts>
                ...
                <SubTextTitle>Caso você queira entrar em contato sinta-se à vontade usando um dos links abaixo</SubTextTitle>
            </SubContainerTexts>

            <SubContainerContact>
                <BoxContact href='https://www.linkedin.com/in/gabarbosabarreto' data-aos="zoom-in">
                    ...
                    <BoxTexts>
                        <TitleContact>Linkedin</TitleContact>
                        <LinkText>https://www.linkedin.com/in/gabarbosabarreto</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxContact href='https://github.com/ogabrielbarbosa' data-aos="zoom-in">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <BoxTexts>
                        <TitleContact>Github</TitleContact>
                        <LinkText>https://github.com/ogabrielbarbosa</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxContact href='mailto:contato@gabarbosa.com' data-aos="zoom-in">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <BoxContact href='https://api.whatsapp.com/send?phone=5512996859020' data-aos="zoom-in">
                    <Icon width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <BoxCV data-aos="zoom-in" href={require("../../cv.pdf")} download="Gabriel Barbosa - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <BoxTexts>
                        <TitleContactCV>CV</TitleContactCV>
                        <LinkTextCV>Download</LinkTextCV>
                    </BoxTexts>
                </BoxCV>
